        ...
        >
            ...
            <div className="relative mx-auto flex max-w-6xl items-center justify-between px-6 py-3.5">
                ...
                <div className="flex items-center gap-1">
                    <Link
                        href="#features"
                        className="rounded-lg px-3.5 py-2 text-[13px] text-zinc-600 transition-all duration-200 hover:bg-white/[0.03] hover:text-zinc-300"
                    >
                        Features
                    </Link>
                    <Link
                    ...
                    <div className="ml-2 h-4 w-px bg-white/[0.05]" />
                    <Link
                        href="/dashboard"
                        className="group relative ml-2 flex items-center gap-1.5 overflow-hidden rounded-lg border border-white/[0.07] bg-white/[0.02] px-4 py-2 text-[13px] font-medium transition-all duration-300 hover:border-emerald-500/20 hover:bg-emerald-500/[0.04]"
                    >
